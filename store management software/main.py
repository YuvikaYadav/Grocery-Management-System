...
class Application:
    def __init__(self, master, *args, **kwargs):
        ...
        # button 
        self.search_btn = Button(self.left, text="Search", width=25, height=2, bg='lightblue', command=self.ajax)
        self.search_btn.place(x=334, y=120)
    ...
    def ajax(self, *args, **kwargs):
        ...
        # get the products into with that id and fill it in the labels above
        ...
        self.productname.configure(text="Product's Name:" + str(self.get_product_name))
        ...
        # add to cart button
        self.add_to_cart_btn = Button(self.left, text="Add To Cart", width=25, height=2, bg='lightblue', command=self.add_to_cart)
        self.add_to_cart_btn.place(x=330, y=450)
        ...
        # button change
        self.change_btn = Button(self.left, text="Calculate Change", width=22, height=2, bg='lightblue', command=self.change_func)
        self.change_btn.place(x=352, y=590)
    ...
    def generate_bill(self, *args, **kwargs):
        ...
        directory = "C:/Users/yuviy/OneDrive/Desktop/store/store management software/Invoice/" + str(date) + "/"
        if not os.path.exists(directory):
            os.makedirs(directory)
            
        # TEMPLATES FOR THE BILL
        company = "\t\t\t\tPython Grocery Store Management\n"
        ...
        file_name = str(directory) + str(random.randrange(500, 1000)) + ".rtf"
        f = open(file_name, 'w')
        f.write(final)
